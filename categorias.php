...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                ...
                <form class="d-flex input-group w-auto" id="formCategoria" method="post" action="conexion.php">
                    <select class="form-select form-select-mb mb-3" aria-label=".form-select-lg example" id="selCat"
                        name="selCat">
    ...
    if($categoria==null){
        ...
        $output = `swipl -s catalogo.pl -g consultarGenero($categoria). -t halt.`;
        $peliculas = explode("*", $output); 
        //print_r($peliculas);
    }
    ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-mb-10">
                <h2 style="text-align:center"><b>Categoría <?php echo $categoria?></b></h2>
                <hr>
            </div>
            <div class="col-mb-1"></div>
        </div>
                    ...
                    <div style="text-align:center">
                        <div class="single-blog">
                            <div class="single-blog-img">
                                <a href="pelicula.php?id=<?php echo $ficha[0]?>&categoria=<?php echo $ficha[1]?>"><img
                                        src="img/<?php echo $ficha[0]?>.jpg" alt="Caratula" style="width:30%" /></a>
                            </div>
                        </div>
                    </div>
